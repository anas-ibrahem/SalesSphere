class DealModel {
    ...
    getEmployeeClosedDeals = async (pool , employeeId) => {
        try {
            const result = await pool.query(`
                SELECT 
                d.*,
    ...
    getSalehOpenDeals = async (pool , employeeId) => {
        try {
            const result = await pool.query(`
                SELECT 
                d.*,
            ...
            JOIN employee_profile e2 ON d.deal_opener = e2.employee_id
            LEFT JOIN employee_profile e ON d.deal_executor = e.employee_id
            WHERE d.status = 0 AND d.deal_opener = $1
            ` , [employeeId]);
            return result.rows;
        }
        catch (error) {
    ...
    getSalehClaimedDeals = async (pool , employeeId) => {
        try {
            const result = await pool.query(`
                SELECT 
                d.*,
            ...
            JOIN employee_profile e2 ON d.deal_opener = e2.employee_id
            LEFT JOIN employee_profile e ON d.deal_executor = e.employee_id
            WHERE d.status = 1 AND d.deal_opener = $1
            ` , [employeeId]);
            return result.rows;
        }
        catch (error) {
    ...
    getSalehClosedDeals = async (pool , employeeId) => {
        try {
            const result = await pool.query(`
                SELECT 
                d.*,
            ...
            JOIN employee_profile e2 ON d.deal_opener = e2.employee_id
            LEFT JOIN employee_profile e ON d.deal_executor = e.employee_id
            WHERE (d.status = 2 OR d.status = 3) AND d.deal_opener = $1
            ` , [employeeId]);
            return result.rows;
        }
        catch (error) {
    ...
    */
    ...
    getEmployeeDeals = async (pool, employeeId) => {
        // Get all deals for an employee
        try {
            const result = await pool.query(`
                SELECT 
                d.*,
            ...
            JOIN employee_profile e2 ON d.deal_opener = e2.employee_id
            LEFT JOIN employee_profile e ON d.deal_executor = e.employee_id
            WHERE deal_executor = $1 OR deal_opener = $1;
            `, [employeeId]);
    ...
    getCustomerDeals = async (pool, customerId) => {
