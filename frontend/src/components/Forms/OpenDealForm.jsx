  ...
  return (
    <div className="bg-white p-6 shadow-md">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
          <label htmlFor="due_date" className="block mb-1 text-gray-600">
            Due Date *
          </label>
          <input
            type="date"
        ...
        <div className="mb-4">
          <label htmlFor="customer_budget" className="block mb-1 text-gray-600">
            Customer Budget *
          </label>
          <input
            type="number"
        ...
        <div className="mb-4 relative">
          <label htmlFor="customer" className="block mb-1 text-gray-600">
            Customer *
          </label>
          <div className="flex items-center">
            ...
            <div
              className={`flex items-center ${selectedCustomer ? "-mt-8" : ""}`}
            >
              <button
                type="button"
