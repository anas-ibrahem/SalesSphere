                      ...
                      return (
                        ...
                        >
                          <div className="w-full">
                            ...
                            <ProgressBar progress={target.avg_progress} color={getTypeColor(target.type).split('-')[1]} />
                            
                            <div className="flex justify-between mt-2">
                              <Typography variant="small" className="font-medium">
                                Progress: {target.avg_progress}% of {target.goal} {target.type === TargetTypes.Revenue && '$'}
                              </Typography>
